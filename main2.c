...
{
	char nombre_carpetas[20][20]={"mazo","mano1","mano2","mano3","mano4","revelada","basurero_uno"};
	int i;
	for(i=0;i<7;i++)
	{
		struct stat st = {0};
...
void vaciar_4carpetas()
{
	...
	char nombre_carpetas[7][20]={"mazo","mano1","mano2","mano3","mano4","revelada","basurero_uno"};
	int i;
	char directorio_elegido[20];
	for(i=0;i<7;i++)
	{
